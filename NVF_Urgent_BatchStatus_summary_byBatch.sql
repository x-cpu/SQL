USE DVA
select distinct Z.Batchname, Z.RMN, Z.BatchStatus, max(s.acktime) AckDateTime
FROM
...
on Z.BatchName = s.batchname
group by Z.RMN, Z.BatchName, Z.BatchStatus
order by Z.RMN, Z.BatchName
