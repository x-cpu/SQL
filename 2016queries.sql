...
select sum(numpages) from document where ftpstime >= '2016-02-17 0:0:0.000' AND ftpstime <= '2016-02-29 23:59:59.999' and pbatch like '02%' 
...
--split dcsids 
select convert(nvarchar, c.insertdate, 101), count(distinct c.dcsid) from cmpRescanMapping c
left join document d
on c.dcsid = d.dcsID
