...
left join FTPError f
on x.imageid = f.imageid
where x.UploadDateTime is null
and f.insertdate > '2020-03-18'
...
--where xACCFTU.UploadDateTime is null and xACCFTU.LastErrorDate is null
--and xACCFTU.ImageID = Z.ImageID
