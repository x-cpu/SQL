--NCC data pull 
select distinct Z.FileNumber, UPPER(Z.Firstname) FirstName, UPPER(Z.MiddleInitial) MiddleInitial, UPPER(Z.Lastname) LastName,
...
where s.ackTime >= '2020-08-01' and s.ackTime < '2020-08-16' 
