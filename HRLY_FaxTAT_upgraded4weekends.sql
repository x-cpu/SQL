...
--select  distinct DATEDIFF(HOUR, '2020-02-28', '2020-03-03') - (DATEDIFF(wk, '2020-02-28', '2020-03-03') * 48)-
--case when DATEPART(dw, '2020-02-28') = 1 then 48 else 0 end +
--case when DATEPART(dw, '2020-03-03') = 1 then 48 else 0 end
--from calendar