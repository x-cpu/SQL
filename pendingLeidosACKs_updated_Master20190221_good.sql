select T.UploadDate, T.BatchName, T.BatchType, 
...
--select * from xLeidosACKResults_List20190219x
--where batchname = '17190370000004'
--order by UploadDate


select * from smsDCSMapping where batchname = '17190370000004'